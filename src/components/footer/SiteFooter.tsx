    ...
    <footer id="contact" className="content-auto relative w-full" aria-label="Contact">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col items-start gap-2 sm:items-end">
              <SocialRow />
              <p
                className="font-mono text-[0.75rem] text-graphite"
                style={{ letterSpacing: '0.08em' }}
              >
                {site.footer.location} &nbsp;•&nbsp; {site.footer.phone}
              </p>
            </div>
          </motion.div>
        </motion.div>
      ...
      <div className="on-noir bg-noir px-[max(1.5rem,7vw)] pb-[clamp(1.75rem,4vw,3rem)] pt-[clamp(0.5rem,1.5vw,1rem)]">
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          >
            © {site.year} {site.firstName} {site.lastName}
          </p>
          <p
            className="meta m-0 font-mono text-white/35"
            style={{ fontSize: 'clamp(0.55rem,0.75vw,0.68rem)', letterSpacing: '0.12em' }}
          >
            VLSI / SEMICONDUCTOR PORTFOLIO
          </p>
        </div>
      </div>
    </footer>
